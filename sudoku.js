...
export class Sudoku {
    ...
    getDuplicatePositions(row, column, value) {
        const duplicatesInColumn = this.getDuplicatesInColumn(row, column, value);
        const duplicatesInRow = this.getDuplicatesInRow(row, column, value);
        const duplicatesInBox = this.getDuplicatesInBox(row, column, value);
    ...
    getDuplicatesInColumn(row, column, value) {
        const duplicates = [];
    ...
    getDuplicatesInRow(row, column, value) {
        const duplicates = [];
    ...
    getDuplicatesInBox(row, column, value) {
        const duplicates = [];
